...
func newTestProfile(name string, generation int64, template datadoghq.DatadogPodAutoscalerTemplate) *datadoghq.DatadogPodAutoscalerProfile {
	return &datadoghq.DatadogPodAutoscalerProfile{
